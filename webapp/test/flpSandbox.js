		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Grup Seyahat Talebi Oluşturma",
									"targetURL": "#comhayatgrupseyahatgrupseyahattalebi-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhayatgrupseyahatgrupseyahattalebi-display": {
								"semanticObject": "comhayatgrupseyahatgrupseyahattalebi",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hayat.grupseyahat.grupseyahattalebi",
									"url": sap.ui.require.toUrl("com/hayat/grupseyahat/grupseyahattalebi")
								}
							}
						}
					}
